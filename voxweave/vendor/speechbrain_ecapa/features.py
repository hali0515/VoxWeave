# Copyright SpeechBrain contributors.
# Licensed under the Apache License, Version 2.0 (see LICENSE in this directory).
#
# Vendored from https://github.com/speechbrain/speechbrain tag v1.0.3
# (commit 31c1e329048c0380dc7f2acbe680c44a036b6286), file(s):
# speechbrain/processing/features.py, speechbrain/lobes/features.py.
# Modifications by the voxweave authors: only the definitions listed below are
# kept and copied verbatim, except that the get_filter_properties helpers are dropped
# and Fbank.forward loses its @fwd_default_precision decorator (a no-op outside
# autocast; voxweave casts the waveform to float32 before calling it and never runs it
# under autocast).
"""features"""
